...
namespace Subasta.Lib
{
	public static class LibStarter
	{
		...
		public static void Start()
		{
			...
			string text = string.Format("Gracias por testear esta versión en estado de desarrollo(Alpha).{0} Esta versión no es estable por lo que se espera que pueda haber errores, estos se notifican al desarrollador automáticamente.{0} Las actualizaciones automaticas incluirán bug fixtures progresivamente.{0} La configuración mínima probada es de 4GB RAM con CPU de 4 hilos, aún así funciona en máquinas inferiores, esto es debido a que la inteligencia artificial implementada requiere optimizaciones.",Environment.NewLine);
